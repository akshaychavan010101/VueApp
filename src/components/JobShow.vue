        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <RouterLink
              ...
              class="bg-green-500 hover:bg-green-600 text-white text-center font-bold py-2 px-4 rounded-full wl-full focus:shadow-outline mt-4 block"
              >Edit Job</RouterLink
            >
            <button
...
const fetchJob = async () => {
  try {
    ...
    if (data.status == 200) {
      ...
      throw new Error("Error in getting job");
    }
  } catch (error) {
